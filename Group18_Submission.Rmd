...
```{r, fig.cap = "Boxplot to examine how the variable is distributed and if there are outliers."}
...
```{r, fig.cap = "Histogram of the trip duration categories to get an overview."}
...
We are interested in finding out at what time of day most bikes are rented. The following graph shows the distribution for each day:
...
```{r, warning=FALSE, message=FALSE, fig.cap = "Map of New York which show with red dots the most and least used stations."}
...
Furthermore, it is of interest how strongly the bike-sharing service is dependent on meteorological factors such as rain, snow and temperatures, respectively how strongly the number of trips is influenced.
