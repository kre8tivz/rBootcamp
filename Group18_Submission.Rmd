...
The second dataset used stems from the National Oceanic and Atmospheric Administration which is part of the U.S. Department of Commerce. The dataset includes weather data measured at the Laguardia Airport in New York which corresponds to the weather station with the number GHCND:USW00014732.
...
```{r create csv with combined samples, echo=TRUE, eval=FALSE,}
