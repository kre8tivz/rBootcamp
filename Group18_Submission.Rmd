...
require(ggeasy)         # Provides a series of aliases to commonly used but difficult to remember 'ggplot2' sequences
...
require(ggmap)          # to visualize spatial data and models on top of static maps from various online sources (i.e. GMaps or Stamen)
require(leaflet)        # for interactive maps
require(leaflet.extras) # add-on to the 'leaflet' package by providing extra functionality
require(st)
require(sf)             # standardized way to encode spatial vector data
require(rgdal)
...
leaflet() %>%
  ...
  addCircles(data = station_ranking_top10,
             ...
             popup = (citi_cb$start.station.name)) %>%
